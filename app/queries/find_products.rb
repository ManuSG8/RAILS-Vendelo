class FindProducts
    attr_reader :products # Metodo getter

    def initialize(products = initial_scope) # Metodo constructor
        @products = products
    end
    ...
    def filter_by_category_id(scoped, category_id)
        return scoped unless category_id.present? # Si no tenemos una categoria, devolvemos lo que habia
